...
# About me
  ...
  I grew up with the internet and always thought it was fascinating but really misterious. Now i'm learning to make those fascinating things myself at school and on my free time.\
  Passionate about video games i did a Game jam at school on Unity and tried doing a few prototypes on godot Engine.\
  But i'm interested by all subjects regarding computers which is why at school we learn about everything, from security to web, passing by software and hardware (which i now know the difference 😁)
  ...
  [^1]: coding clubs are events where anyone can come to our school and learn how to code in different beginer-friendly languages on fun mini-projects
...
# Personnal projects
  ...
  ## Goal
   Make a C99 library that fits my needs, **[check it out here](https://github.com/Pereira-Romeo/My_lib)**!

  ## How
   in C (because its a C library...), helped by myself 🥖, Epitech, StackOverflow and the web. \
   also in makefile and bash for automation (mainly clean up scripts)
  ...
  ## Goal
   Make a portfolio (surprising i know)
